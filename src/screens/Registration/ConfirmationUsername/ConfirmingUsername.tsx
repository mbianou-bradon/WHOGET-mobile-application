...
export default function ConfirmingUsername() {
  ...
  const [userTown, setUserTown] = React.useState<string>("");
  // const [userCameroon, setUserCameroon] = React.useState<string>("")
              ...
              <View style={styles.changeUsernameContainer}>
                ...
                <View>
                  <TextInput
                    ...
                    defaultValue={newUserInfoUsername}
            ...
            <View style={styles.usernameSubContainer}>
              ...
              <View style={styles.changeUsernameContainer}>
                ...
                <View>
                  <TextInput
                    placeholder={"Eg: Buea"}
                    onChangeText={value => setUserTown(value)}
                    defaultValue={newUserInfoUsername}
                    style={{paddingLeft: 10}}
                    editable
                  />
